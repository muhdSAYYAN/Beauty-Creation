...
const filteredproduct = cometics.slice(0,6).filter((product)=>
...
const filteredItems = filteredbycategory();
  ...
  return (
    <div className='face'>
    {/* <ProductPage onPriceRangeChange={handlePriceRangeChange}/> */}
...
<div className='productsall'>
  ...
  <div className="brandDiv">
    ...
    {filteredItems.length > 0 ? (
         ...
         <Link to='/detailing' className='addtocart' state={{selectedProduct:item}}><span >ADD TO BAG . ₹{item.Pprice} <label className='offer'>₹{item.Rprice}</label></span></Link> 
        </div>
